#library(tidyverse)
#library(lubridate)
form_data <- read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vTi4w0Il1rmXgdfBpzRxsB6LBiA3gY0HMHg-0JHRQC9Uw7ZCkXe_Kr7KEuT-1GKAQ-NQJxsw2V8CiTn/pub?gid=1435256090&single=true&output=csv")
...
video_watch <- num_video %>%
  ...
  labs (
             title = "What type of videos watched reguarly",
...
jitter_watch <- time_plot %>%
  ...
  labs(
    ...
    x = "Time of day",
    y = "Hour (24h)",
    caption = "Data: personal YouTube logging"
  ) +
  my_theme
